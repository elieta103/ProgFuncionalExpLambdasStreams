...
public class _14ExerciseLambdas {

    public static void main(String[] args) {
        Stream<Videogame> videogames = Database.videogames.stream();
        //System.out.println("Response exercise1 : "+ exercise1(videogames));
        //exercise2(videogames).forEach(System.out::println);
        //System.out.println("Response exercise3 : "+ exercise3(videogames));
    ...
    * y no este en descuento o su precio sea mayor a 9.99 de lo contrario regresar false.
    ...
    static Boolean exercise1(Stream<Videogame> stream) {
        boolean result = stream
                .anyMatch(videogame -> videogame.getTotalSold()>10 && (!videogame.getIsDiscount() || videogame.getPrice()>9.99) );
        return result;
    }
    ...
    static Stream<Double> exercise5(Stream<Videogame> stream) {
        return stream
                ...
                .takeWhile(videogame -> videogame.getPrice()<20)
